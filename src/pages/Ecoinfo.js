    ...
    return (
        <div className="eco-container">
            <div className="eco-hero">
                <h1>Miért válassz ököszállást?</h1>
                <p>
                    Az ököszállások olyan szálláshelyek, amelyek a fenntarthatóság és a
            ...
            <div className="eco-section">
                ...
                <p>
                    Az ököszállások fenntartható forrásokból működnek, csökkentve az
                ...
                <p>
                    Az ököszállások legtöbbször természetvédelmi területeken vagy zöld
                ...
                <p>
                    Sok ököszállás együttműködik helyi termelőkkel és kézművesekkel, biztosítva,
                ...
                <p>
                    Az ököszállásokban természetes anyagokkal, tiszta levegővel és csendes
            ...
            <div className="eco-footer">
                <p>
                    Az ököszállások nemcsak pihenést nyújtanak, hanem lehetőséget az élmények,
