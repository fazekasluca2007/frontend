      ...
      <div className="profile-card">
        ...
        {!editMode && (
          <div className="view-avatar-wrapper">
            <img src={customAvatar || selectedAvatar} alt="Profilkép" className="profile-avatar view-avatar" />
          </div>
        )}
          ...
          <div className={editMode ? "edit-layout" : ""}>
            ...
            <div className="right-column">
              ...
              <div className="field">
                ...
                <input type="text" value={username} disabled={!editMode} onChange={(e) => setUsername(e.target.value)} />
              </div>
              <div className="field">
                <label>Email</label>
