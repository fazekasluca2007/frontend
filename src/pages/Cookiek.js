        ...
        <div className="cookiek-page">
            <div className="cookiek-container">
                ...
                <div className="cookiek-section">
                    ...
                    <p>
                        Az EcoTrip weboldal sütiket (cookie-kat) használ a weboldal működésének biztosítására és a
                        felhasználói élmény javítására. A sütik segítenek például:
                    </p>
                    <ul>
                ...
                <div className="cookiek-section">
                    ...
                    <p>
                        A felhasználó dönthet, hogy csak a szükséges sütiket engedélyezi, vagy mindet elfogadja.
                        A cookie-beállításokat bármikor módosíthatod a böngésződ beállításain keresztül.
                        Fontos tudni, hogy bizonyos funkciók, például a személyre szabott ajánlatok, nem fognak megfelelően működni, ha csak a szükséges cookie-kat engedélyezed.
                    </p>
                    <p>
                        Továbbá rendszeresen frissítjük a cookie szabályzatot, hogy megfeleljünk a jogszabályi változásoknak.
                        Érdemes időnként újra átnézni ezt az oldalt, hogy mindig tisztában legyél a használt sütikkel és azok céljával.
                    </p>
                </div>
